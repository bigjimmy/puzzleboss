...
if (@activityrows < 1){
	print "<body>No google doc activity for puzzle $puzzlerow{'name'} or error fetching<br>";
} else {
...
print "<br><b>Are you sure you want to delete this puzzle: $puzzlerow{'name'} in round $puzzlerow{'round'}?<br></b>\n";
