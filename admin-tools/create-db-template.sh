...
mysqldump --add-drop-database -d --databases $PB_DATA_DB_NAME -u $PB_DATA_DB_USER -P $PB_DATA_DB_PORT -h $PB_DATA_DB_HOST --password=$PB_DATA_DB_PASS > $PB_PATH/db/puzzlebossnew
