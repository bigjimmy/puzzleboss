...
sub message {
    ...
    my $remote  = IO::Socket::INET->new(
      ...
      or debug_log(
"PB::Meteor cannot connect to meteor server at $PB::Config::METEOR_CONTROL_HOST on port $PB::Config::METEOR_CONTROL_PORT",
        0
      );
    ...
    if ($response =~ m/OK/) {
        ...
        close $remote;
        debug_log(
            "PB::Meteor response OK for channel $channel message $message\n",
            2);
        return (1);
    } else {
